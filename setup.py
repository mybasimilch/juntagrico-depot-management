...
import juntagrico_depot_management
...
setup(
    name=juntagrico_depot_management.name,
    version=juntagrico_depot_management.version,
    packages=find_packages(),
    include_package_data=True,
    license='LPGLv3',  # example license
    description='juntagrico-depot-management',
